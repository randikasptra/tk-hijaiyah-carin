...
class HurufSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            ['nama' => 'Zho', 'gambar' => 'assets/img/17.Zho.png'],
            ['nama' => 'Ain', 'gambar' => 'assets/img/18.Ain.png'],
            ['nama' => 'Ghain', 'gambar' => 'assets/img/19.Ghain.png'],
            ...
            ['nama' => 'Wawu', 'gambar' => 'assets/img/26.Wawu.png'],
            ['nama' => 'Ha', 'gambar' => 'assets/img/27.Haa.png'],
